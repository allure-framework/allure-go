...
// extensionsByType mirrors allure-js EXTENSIONS_BY_TYPE for deterministic attachment source names.
// Source: https://github.com/allure-framework/allure-js/blob/main/packages/allure-js-commons/src/sdk/reporter/utils/extensions.ts
...
func extensionForContentType(contentType string) string {
	...
	if extension, ok := extensionsByType[normalized]; ok {
		return extension
	}
	base, _, _ := strings.Cut(normalized, ";")
	base = strings.TrimSpace(base)
	if extension, ok := extensionsByType[base]; ok {
		return extension
	}
	return ""
}
